...
namespace ManualidadesEunice.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ClientesController(EuniceContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CodigoCliente,NombreCliente,Telefono,Direccion,Estado,FechaRegistro")] Cliente cliente)
        {
